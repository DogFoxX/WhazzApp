<script>
    ...
    // Variables
    let i, list, settStore = $subMenuContent.settStore, countryCode = settStore.get('country-code');
...
<div class="form">
    <div class="form-content" spellcheck="false">
        <input on:input={searchInput} type="text" class="search-input" placeholder="Search {countryCodes.length} Country Names/Codes">
    </div>
</div>
